...
# first need to fill this column  
...
df_dirty=pd.get_dummies(df_dirty,columns=['Experience_Years'],dtype=int)
...
df_dirty.to_csv('Dataset_6.csv',index=False)


# be the best version that you imagine yourself.................